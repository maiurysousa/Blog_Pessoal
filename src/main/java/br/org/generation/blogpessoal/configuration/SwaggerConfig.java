...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Flóreo - Blog Pessoal")
			.description("API do Projeto Blog Pessoal - Flóreo")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/maiurysousa")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Maiury Sousa", 
			"https://github.com/maiurysousa", 
			"maiuryprogramando@gmail.com");
